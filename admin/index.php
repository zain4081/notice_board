...
<html lang="en">
  ...
  <body>
    ...
    @$page=  $_GET['page'];
      ...
      if($page=="reject_users")
      {
        include('reject_users.php');
      ...
      <h1 class="page-header">Dashboard</h1>
          ...
          <div class="row" id="dashboard">
              <a class="col-xs-4 col-sm-4 btn btn-primary btn-lg" href="index.php?page=notification">
                <div><span class="glyphicon glyphicon-envelope"></span></div>
                <div>Manage  Notification</div>
              </a>
              <div class="col-sx-1 col-sm-1"></div>
              <a class="col-xs-4 col-sm-4 btn btn-info btn-lg" href="index.php?page=manage_users">
